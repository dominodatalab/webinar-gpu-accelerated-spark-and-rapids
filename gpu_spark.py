...
orig_perf_path="/domino/datasets/local/mortgage/perf/*"
orig_acq_path="/domino/datasets/local/mortgage/acq/*"

out_path = "/domino/datasets/local/mortgage/out"

tmp_perf_path = out_path + "/perf/"
tmp_acq_path = out_path + "/acq/"
output_path = out_path + "/output/"

empty_folder(tmp_perf_path)
empty_folder(tmp_acq_path)
